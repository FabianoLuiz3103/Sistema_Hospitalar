			...
			<div class="card shadow-lg border border-0 w-50">
				...
				<form class="mt-3 d-flex flex-column align-items-center"
					...
					<div class="mb-3">
						<div class="d-flex">
							<input type="text"
								class="shadow-lg form-control custom-input me-4 " id="nome_pac"
								name="nome_pac" maxlength="50" placeholder="Nome completo"
