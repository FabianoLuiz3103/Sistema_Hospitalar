					...
					<div class="card shadow-lg border border-0 w-50">
						...
						<form class="mt-3 d-flex flex-column align-items-center"
							...
							<input type="hidden" value="editar" name="acao"> <input
								type="hidden" value="${medico.cod_medico}"
								name="cod_paciente">
							<div class="mb-3">
								<div class="d-flex">
									<input type="text"
										class="shadow-lg form-control custom-input me-4 "
										id="nome_med" name="nome_med" maxlength="50"
										placeholder="Nome completo" required style="width: 40vh"
										value="${medico.nome}"> <input type="email"
										...
										style="width: 40vh" value="${medico.email}">
								</div>
							...
							<div class="mb-3">
								<div class="d-flex">
									<input type="tel"
										...
										style="width: 40vh" value="${medico.telefone}"> <input
										type="text"
										...
										style="width: 40vh" value="${medico.crm}">
								</div>
							...
							<div class="mb-3">
								<div class="position-relative">
									<input type="password"
										...
										required style="width: 40vh" value="${medico.senha}">
