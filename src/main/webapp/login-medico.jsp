		...
		<main class="d-flex justify-content-center align-items-center"
			...
			<div class="card shadow-lg border border-0 w-50">
				...
				<form class="mt-3 d-flex flex-column align-items-center"
					...
					<input type="hidden" value="medicoLogin" name="acaoLogin">
					<div class="mb-3">
						<div class="d-flex">
							<input type="text"
					...
					<div class="d-flex justify-content-center w-100 mb-3">
						<a href="medico?acao=abrir-form-cadastro"><button type="button"
			...
			<div class="modal" id="modalSenha" tabindex="-1">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="formCpfSenha" action="medico" method="post">
								<input type="hidden" value="verifica-crm" name="acao">
								<div class="d-flex justify-content-center flex-column">
									<div class="mb-3">
										<div class="d-flex">
											<input type="text"
												class="form-control custom-input <%=request.getAttribute("crmInvalid") != null ? "is-invalid" : ""%>"
												id="crmS" name="crmS" minlenght="9" maxlength="9"
												placeholder="CRM" required
												style="max-width: 500px;">
										</div>
										<c:if test="${not empty crmMsg }">
												<p class="text-danger" style="font-size: 10px">${crmMsg}</p>
										</c:if>
										
										<c:if test="${crmInvalid eq true}">
											<script>
				...
				<div class="modal fade" id="modalAltSenha" tabindex="-1"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="formAltSenha" action="medico" method="post">
