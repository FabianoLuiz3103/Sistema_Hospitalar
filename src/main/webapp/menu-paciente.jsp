	...
	<header class="l-header containerColor">
		...
		<div class="l-header-menu">
			<div class="l-header-menu-wrapper">
				...
				</a> <a href="/Aluno/LogOff" class="l-header-link"> <i
					class="fas fa-power-off me-2"></i> Sair
				</a>
			</div>
		</div>
		...
		<div class="l-header-wrapper ">
			<div class="l-header-box">
				...
				<h1 class="l-header-title">Olá
					${sessionScope.dadosPaciente.getNome()},</h1>

				<p class="l-header-subtitle">Seja bem-vindo ao Portal Harmony
					Health.</p>
		...
		<div class="l-content-wrapper ">
			...
			<div class="l-content-left">
				<div id='aulas' class='l-content-tab'>
					...
					<a
						href='paciente?acao=abrir-form-edicao&cod_paciente=${sessionScope.codPaciente}'
						class='l-servico '> <span class='l-servico-box'> <span
							class='l-servico-box-wrapper'> <span
								class='l-servico-media'> <img
									src="./imagens/user-interface.png" alt="">
							</span> <strong class='l-servico-title'> <span
									class='l-servico-title-text'> Dados cadastrais </span>
							</strong>

						</span>
					</span>
					</a> <a href='paciente?acao=agendar' class='l-servico '> <span
						class='l-servico-box'> <span class='l-servico-box-wrapper'>
								<span class='l-servico-media'> <img
									src="./imagens/calendario.png" alt="">
							</span> <strong class='l-servico-title'> <span
									class='l-servico-title-text'> Agendamento de consulta </span>
							</strong>

						</span>
					</span>
					</a> <a
						href='paciente?acao=biometricos&cod_paciente=${sessionScope.dadosPaciente.getCod_paciente()}'
						class='l-servico '> <span class='l-servico-box'> <span
							class='l-servico-box-wrapper'> <span
								class='l-servico-media'> <img
									src="./imagens/dados_bio.png" alt="">
							</span> <strong class='l-servico-title'> <span
									class='l-servico-title-text'> Resultados de exames </span>
							</strong>

						</span>
					</span>
					</a> <a href='GraficosPac.jsp'
						class='l-servico '> <span class='l-servico-box'> <span
							class='l-servico-box-wrapper'> <span
								class='l-servico-media'> <img
									src="./imagens/painel-de-controle.png" alt="">
							</span> <strong class='l-servico-title'> <span
									class='l-servico-title-text'> Infográficos </span>
							</strong>
